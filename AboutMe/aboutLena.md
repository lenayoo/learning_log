...
### Q. “왜 선행학습은 도움이 안 되었을까?"

**A.**  
🎓 “선행학습”은 맥락이 없어.
→ 내가 왜 배우는지, 어디에 쓰는지 모르니까
→ 금방 잊히고, 스스로도 ‘쓸모 없는 공부’처럼 느껴져

🤖 튜토리얼만 반복하면 “실력 착각”에 빠져
→ "이거 나 아는 것 같아" → 하지만 실전에서 안 써봄
→ 결과적으로, 어디에도 쓰이지 않는 공부가 되어버려

나의 성장공식:
→ 지금 내가 완성할 수 있는 걸 완성하고,
다음 필요가 생기면 그때 배우는 것.
그게 쌓이는 실력이고, 지속 가능한 성장이야.
